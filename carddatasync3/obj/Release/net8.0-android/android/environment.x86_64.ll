...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1080300176441630102, ; hash 0xefdff496b985d96, from name: carddatasync3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 24
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1791392489213894868, ; hash 0x18dc4dfa4ce5a0d4, from name: libaot-carddatasync3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	...
	%struct.DSOCacheEntry {
		i64 3248593317598336649, ; hash 0x2d1552691b281689, from name: aot-carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 81
	...
	%struct.DSOCacheEntry {
		i64 12006342959291357617, ; hash 0xa69f194f2412d9b1, from name: carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 306
	...
	%struct.DSOCacheEntry {
		i64 12555590195184194407, ; hash 0xae3e6ac29954d367, from name: libaot-carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 322
	...
	%struct.DSOCacheEntry {
		i64 16462706528185178334, ; hash 0xe477485d3dfb58de, from name: aot-carddatasync3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f52db1d8-b39a-4a5f-b84f-75cf626acaab\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.carddatasync3\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-carddatasync3.dll.so\00", align 16
