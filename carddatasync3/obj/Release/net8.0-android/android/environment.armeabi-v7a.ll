...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 238826630, ; hash 0xe3c3486, from name: libaot-carddatasync3.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 620444717, ; hash 0x24fb3c2d, from name: aot-carddatasync3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 62
	...
	%struct.DSOCacheEntry {
		i64 857821340, ; hash 0x3321509c, from name: carddatasync3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 89
	...
	%struct.DSOCacheEntry {
		i64 2561963098, ; hash 0x98b4745a, from name: carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 283
	%struct.DSOCacheEntry {
		i64 2565553366, ; hash 0x98eb3cd6, from name: aot-carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 284
	...
	%struct.DSOCacheEntry {
		i64 3425181407, ; hash 0xcc281edf, from name: libaot-carddatasync3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-carddatasync3.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
